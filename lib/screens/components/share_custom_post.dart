...
class ShareCustomPost extends StatefulWidget {
  ShareCustomPost({
    Key? key,
    this.hideBelowImage,
    this.postModel,
  ...
  String? createdTime;
  int? originalPostId;
  PostModel? originalPostModel;
  @override
  State<ShareCustomPost> createState() => _ShareCustomPostState();
}

class _ShareCustomPostState extends State<ShareCustomPost> {
  ...
  void initState() {
    ...
    final jiffyTime = Jiffy(widget.postModel?.createdAt!.toDate()).fromNow();

    /// Manipulate the string to show LinkedIn type dateTime in post
    innerPostJiffyTime = jiffyTime
        .toString()
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      padding: EdgeInsets.only(
          ...
          top: 9.h,
          bottom:
              (widget.hideBelowImage == null || widget.hideBelowImage == false)
                  ? 9.h
                  : 0),
        ...
        children: [
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        widget.postModel?.postAddress != null
                            ? Text(
                                widget.postModel!.postAddress.toString(),
                                style: AppTextStyle.bodyMedium.copyWith(
                                  fontSize: kFontSize12,
                                  fontWeight: FontWeight.w300,
                                ),
          ...
          (widget.postModel?.postType == "imagePost" ||
              ...
              : widget.postModel?.postType == "DocPost"
                  ...
                  ? Container(
                      height:
                          widget.postModel!.fileType == 'pdf' ? 290.h : 45.h,
                      width: double.infinity,
                      decoration: BoxDecoration(
                      ...
                      child: widget.postModel?.postImage != null
                          ? widget.postModel!.fileType == 'pdf'
                              ...
                              : InkWell(
                                  onTap: () {
                                    openFile(
                                      url: widget.postModel!.postImage
                                          .toString(),
                                  ...
                                  child: Row(
                                    children: [
                                      ...
                                      Text(
                                        widget.postModel!.fileType.toString(),
                              ...
                              children: [
                                ...
                                Container(
                                  ...
                                  decoration: BoxDecoration(
                                    ...
                                    border:
                                        Border.all(color: AppColors.white500),
                                  ),
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Padding(
                                        padding:
                                            const EdgeInsets.only(bottom: 02),
                                        child: Padding(
                                                          ...
                                                          : Padding(
                                                              ...
                                                              child:
                                                                ...
                                                                onPressed: () {
                                                                  ...
                                                                  createPostController.voteOnPollFieldController(
                                                                      // widget
                                                                      //     .postModel!
                                                                      //     .id!,
                                                                  ...
                                                                  createPostController.updateVotersFieldController(
                                                                      // widget
                                                                      //     .postModel!
                                                                      //     .id!,
                                                                      widget.originalPostId!,
